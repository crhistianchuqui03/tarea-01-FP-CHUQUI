...
if num>=5:
        ...
        signo = str(input("itrodusca el signo"))
        if(signo == 'p' or signo == 'P' or signo =='%' ):
             raizModulo = int(input("introdusca el numero: "))
        else:
            num1 = int(input("introdusca el numero 1: "))
            num2 = int(input("itrodusca el numero 2: "))
        if(signo == '*' ):
            resultado= num1*num2
    ...
    precio = int(input("ingrese el monto de venta:"))
    igv= 0
    if(precio >= 2000 ):
        igv=precio*0.1
        totalpagar =igv +precio
        print('IGV', igv)
        print(' el monto total a pagar: ', totalpagar)
    elif(precio >= 1000):
        igv=precio*0.05
        totalpagar =igv +precio
        print('IGV ', igv)
